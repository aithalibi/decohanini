  ...
  return (
    <header className="sticky top-0 z-20 flex min-h-[74px] items-center gap-4 border-b border-brand-sand bg-brand-cream/95 px-4 py-3 backdrop-blur-lg sm:px-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <a href={publicSiteUrl} target="_blank" rel="noopener noreferrer" className="hidden items-center gap-2 rounded-full border border-brand-taupe bg-brand-white px-4 py-2 text-xs font-semibold text-brand-brown hover:bg-brand-sand sm:flex"><ExternalLink size={15} />{isArabic ? 'عرض الموقع' : 'Voir le site'}</a>
